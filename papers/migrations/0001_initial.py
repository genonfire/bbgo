# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-07-09 02:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('2progress', 'status_progress'), ('1proposed', 'status_proposed'), ('3rejected', 'status_rejected'), ('4canceled', '\ucde8\uc18c'), ('5completed', 'status_completed')], default='1proposed', max_length=12)),
